...
public class IPersonalFinanceApp implements IPersonalFinance {
    ...
    public static void main(String[] args) {
       Date firstDate = new Date();
        ...
        IAccount Kerry = new Cash("Kerry",40.00);
        ICategory category = new Category("Food", Category.TransactionType.EXPENDITURE);
        DebitAccount debit = new DebitAccount(5, firstDate, category, Kerry, "I paid for food" );
